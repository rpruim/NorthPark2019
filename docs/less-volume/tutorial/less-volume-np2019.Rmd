...
What advantage do we get from using facets (and `day_of_year`)?
...
Copy and paste it into this [Google presentation](https://docs.google.com/presentation/d/1nl3XHQGbYPeG_mf4aBBGaEFDKGerABc3AvuZNA7PsnM/edit?usp=sharing)
...
R includes a number of statistical summary functions, but out of the box, they
don't know about formulas. The `mosaic` package augments these to make them
"formula-aware".  This works for functions like 
